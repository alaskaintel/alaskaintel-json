...
FEEDS = [
    ...
    {"name": "Fairbanks News-Miner", "url": "https://www.newsminer.com/search/?f=rss&t=article&l=50&s=start_time&sd=desc", "category": "Regional"},
    {"name": "Kodiak Daily Mirror", "url": "https://www.kodiakdailymirror.com/search/?f=rss&t=article&l=50&s=start_time&sd=desc", "category": "Regional"},
    {"name": "Mat-Su Frontiersman", "url": "https://www.frontiersman.com/search/?f=rss&t=article&l=50&s=start_time&sd=desc", "category": "Regional"},
    ...
    {"name": "Delta Wind", "url": "https://www.adn.com/arc/outboundfeeds/rss/category/delta-wind/", "category": "Regional"},
    {"name": "Arctic Sounder", "url": "https://www.adn.com/arc/outboundfeeds/rss/category/arctic-sounder/", "category": "Regional"},
    
    # === INDUSTRY & ECONOMY (23-31) ===
    {"name": "ADF&G Commercial Fisheries", "url": "https://proxy.alaskaintel.com/rss/adfg-cf", "category": "Fisheries"},
    {"name": "ADF&G Sport Fishing", "url": "https://proxy.alaskaintel.com/rss/adfg-sf", "category": "Fisheries"},
    {"name": "NOAA Fisheries Alaska", "url": "https://proxy.alaskaintel.com/rss/noaa-fisheries", "category": "Fisheries"},
    ...
    {"name": "Alaska DPS", "url": "https://proxy.alaskaintel.com/rss/ast", "category": "Safety"},
    ...
    {"name": "USACE Alaska District", "url": "https://proxy.alaskaintel.com/rss/usace", "category": "Government"},
    ...
    {"name": "NWS Anchorage", "url": "https://weather.gov/rss_page.php?site_name=nws", "category": "Weather"},
    {"name": "NWS Fairbanks", "url": "https://weather.gov/rss_page.php?site_name=nws", "category": "Weather"},
    {"name": "NWS Juneau", "url": "https://weather.gov/rss_page.php?site_name=nws", "category": "Weather"},
    {"name": "Tsunami Warning Center", "url": "https://tsunami.gov/rss/tsunami.xml", "category": "Emergency"},
    {"name": "Alaska Volcano Observatory", "url": "https://avo.alaska.edu/rss.xml", "category": "Emergency"},
    {"name": "Alaska 511 Road Conditions", "url": "https://511.alaska.gov/rss", "category": "Safety"},
    {"name": "National Fire Center", "url": "https://proxy.alaskaintel.com/rss/nifc", "category": "Emergency"},
    ...
    {"name": "ADF&G Alaska Commercial", "url": "https://proxy.alaskaintel.com/rss/adfg-cf", "category": "Fisheries"},
    ...
    {"name": "Marine Exchange of Alaska", "url": "https://www.mxak.org/comments/feed/", "category": "Maritime"},
    
    # === FEDERAL AGENCIES (67-73) ===
    {"name": "BLM Alaska Frontiers", "url": "https://blm.gov/feedback", "category": "Government"},
    ...
    {"name": "Alaska Power Association", "url": "https://www.alaskapower.org/feed/", "category": "Energy"},
    ...
    {"name": "Alaska Railroad News", "url": "https://alaskarailroad.com/rss.xml", "category": "Transportation"},
    ...
    {"name": "Alaska SeaLife Center", "url": "https://alaskasealife.org/science_blog_rss", "category": "Research"},
    ...
    {"name": "KUCB Unalaska", "url": "https://www.kucb.org/local-news.rss", "category": "Radio"},
    {"name": "KNBA Anchorage", "url": "https://www.knba.org/news.rss", "category": "Radio"},
    {"name": "KUAC Fairbanks", "url": "https://fm.kuac.org/index.rss", "category": "Radio"},
    ...
    {"name": "ADF&G All Regions Fish News", "url": "https://proxy.alaskaintel.com/rss/adfg-cf", "category": "Fisheries"},
    {"name": "ADF&G Emergency Orders", "url": "https://proxy.alaskaintel.com/rss/adfg-sf", "category": "Fisheries"},
    ...
    {"name": "Arctic Web Map / NOAA Arctic", "url": "https://arctic.noaa.gov/comments/feed/", "category": "Science"},

    # === ALASKA STATE LEGISLATURE ===
    {"name": "Alaska Senate Majority", "url": "https://alaskasenate.org/feed", "category": "Government"},
    {"name": "Alaska House Majority", "url": "https://alaskahousemajority.com/feed/", "category": "Government"},
    ...
    {"name": "Alaska Statewide Parks", "url": "https://dnr.alaska.gov/rss.xml", "category": "Parks"},
    ...
    {"name": "Bering Straits Native Corp", "url": "https://beringstraits.com/comments/feed/", "category": "Native"},
    ...
    {"name": "SCF Nuka Podcast", "url": "https://scfnuka.com/comments/feed/", "category": "Health"},
    ...
    {"name": "KYUK Bethel Indigenous Radio", "url": "https://www.kyuk.org/index.rss", "category": "Native"},
    ...
    {"name": "Valdez Avalanche", "url": "https://alaskasnow.org/comments/feed/", "category": "Emergency"},
    ...
    {"name": "DEC Air Quality Advisories", "url": "https://proxy.alaskaintel.com/rss/dec-air", "category": "Environment"},
    {"name": "USGS Alaska Science", "url": "https://www.usgs.gov/feed", "category": "Science"},
    {"name": "ADF&G Emergency Orders", "url": "https://proxy.alaskaintel.com/rss/adfg-sf", "category": "Fisheries"},
]
...
def is_bad_rss_item(title: str, link: str, summary: str, feed_name: str = "") -> bool:
    """Drop known bad feed items (tracker, payments, image uploads, embed payloads, low signal)."""
    link_l = link.lower()
    ...
    # Drop static corporate/CMS pages masquerading as news.
    # These typically have very short titles and summaries that match the title exactly (or empty).
    # We exempt NWS/USGS/Emergency feeds just in case they push valid ultra-short alerts.
    exempt_keywords = ["nws", "usgs", "emergency", "tsunami", "earthquake", "alert", "fire", "police", "trooper"]
    is_exempt = any(kw in feed_name.lower() for kw in exempt_keywords)
    
    if not is_exempt:
        cleaned_summary_l = clean_text(summary).lower()
        if cleaned_summary_l == title_l or cleaned_summary_l == "":
            return True
...
def fetch_feeds() -> List[Dict]:
    ...
    for i, feed in enumerate(feeds_to_fetch, 1):
        ...
        try:
            # request using interceptor to bypass blocks and heal xml
            ...
            for entry in parsed.entries:
                ...
                title = raw_title
                if is_bad_rss_item(title, link, raw_summary, feed['name']):
                    continue
...
def save_data(new_data: List[Dict]):
    ...
    for item in merged_by_hash.values():
        ...
        if is_bad_rss_item(title, link, summary, source):
            continue
