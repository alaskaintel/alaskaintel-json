...
5. **No Technical Drift**: The `master` branch is the production baseline. No divergent branches or alternative folder structures are allowed for signal ingestion.
